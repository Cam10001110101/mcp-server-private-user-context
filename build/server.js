...
function isAddPersonalInfoInput(args) {
...
function isUpdatePersonalInfoInput(args) {
    return (typeof args.id === 'string' &&
        typeof args.data === 'object' &&
        args.data !== null);
}
function isGetPersonalInfoInput(args) {
    return ((args.id === undefined || typeof args.id === 'string') &&
